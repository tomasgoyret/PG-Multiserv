                                                    ...
                                                    <div className="w-full flex justify-center items-center h-3/6">
                                                        ...
                                                        >
                                                            <Image
                                                                ...
                                                                imagen={WP}
                                                                imgClass={`object-cover rounded-t-lg w-10 h-10 rounded-2xl ${loadingImg || failedImg ? "hidden" : ""
                                                                    }`}
                                                            />
                                                        </a>
                                                        <a
                                                        ...
                                                        >
                                                            <Image
                                                                ...
                                                                imagen={TW}
                                                                imgClass={`object-cover rounded-t-lg w-10 h-10 ${loadingImg || failedImg ? "hidden" : ""
                                                                    }`}
                                                            />
                                                        </a>
                                                        <a
