            ...
            <div className="w-4/5 overflow-y-auto h-screen">
                
                {
                    ...
                    <div className="w-full flex flex-col border-2">
                        ...
                        <div className="w-full flex border-2 items-center py-2 px-2 mt-20">
                            <div className="h-20 w-24 rounded-full mr-4" style={{backgroundImage: `url(${ImagenPerfil})`, backgroundSize: "cover"}}></div>
                            <div className="flex flex-col w-1/2">
                                <h2 className="text-2xl font-semibold font-sans">Sebastian Murillo (Cliente)</h2>
                                <span className="text-gray-500 text-sm -mt-1">bastianmurilloalzate@gmail.com</span>
                                <span className="text-gray-800 font-sans font-semibold text-md ">ID: 1</span>
                            </div>
                        ...
                        {/* <div className="w-full flex border-2 items-center py-2 px-2 mt-20">
                            ...
                            <div className="flex w-1/2 justify-end">
                                <div className="flex w-70">
                                    ...
                                    <button 
                                        className="mx-2 flex w-full flex-nowrap p-2 py-1 px-4 justify-center items-center rounded-md font-semibold bg-red-800 hover:bg-red-900 text-gray-50"
                                    >
                                    Eliminar 
                                    </button>
                                </div>
...

                {
                    ...
                    <div className="w-full flex flex-col border-2">
                        ...
                        <div className="w-full flex border-2 items-center py-2 px-2 mt-20">
                            <div className="h-20 w-24 rounded-full mr-4" style={{backgroundImage: `url(${ImagenPerfil})`, backgroundSize: "cover"}}></div>
                            <div className="flex flex-col w-1/2">
                                <h2 className="text-2xl font-semibold font-sans">Manuel Noreña (Provedor)</h2>
                                <span className="text-gray-500 text-sm -mt-1">manuelnoreña@gmail.com</span>
                                <span className="text-gray-800 font-sans font-semibold text-md ">ID: 19</span>
                            </div>
                            <div className="flex w-1/2 justify-end">
                                <div className="flex w-80 items-center">
                                    <div className="w-12 h-4 rounded-lg bg-gray-500 mr-2"></div>
                                    <button 
                                        className="mx-2 flex w-full flex-nowrap p-2 py-2 px-4 justify-center items-center rounded-md font-semibold bg-blue-800 hover:bg-blue-900 text-gray-50"
                                    >
                                    Volver Admin 
...

                {
                    ...
                    <div className="w-full flex flex-col border-2">
                        ...
                        <div className="w-full flex border-2 items-center py-4 px-4 mt-20">
                            <div className="flex flex-col w-1/2">
                                <h2 className="text-2xl font-semibold font-sans">Peluqueria</h2>
                                <span className="text-gray-700 font-sans font-semibold text-sm ">ID: 19</span>
                            </div>
                            <div className="flex w-1/2 justify-end">
                                <div className="flex w-80 items-center">
                                    <button 
...

                {
                    ...
                    <div className="w-full flex flex-col border-2">
                        ...
                        <div className="w-full flex border-2 items-center py-4 px-4 mt-20">
                            <div className="flex flex-col w-1/2">
                                <h2 className="text-2xl font-semibold font-sans">Plomeria don Juan ($100)</h2>
                                <span className="text-gray-700 font-sans font-semibold text-sm ">ID: 19</span>
                            </div>
