...
const HomeNavigation = () => {
    ...
    const arr = [
        ...
        datosSesionFromLocalStorage ? <LinkTo linkClass='m-4 flex justify-center' page={`home/${datosSesionFromLocalStorage.uid}/appointments`} render={<AiFillCalendar size='30' color='white' />} /> : null
    ]
    const newService = () => {
        setVerPerfil(false)
